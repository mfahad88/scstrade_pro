                ...
                child: Column(
                  ...
                  children: [
                        ...
                        children: [
                          ...
                          Icon(
                            ...
                            element.indexCode == provider.selectedIndex,)
                                ...
                                .first
                                .netChange!
                                .contains('-') ? Icons.arrow_drop_down : Icons
                                .arrow_drop_up,
                            color: provider.indices!
                                .where((element) =>
                            element.indexCode == provider.selectedIndex,)
                                .toList()
                                .first
                    ...
                    Padding(
                      ...
                      child: Row(
                        children: [
                          ...
                          const Spacer(),
                          Text('${Utils.roundTwoDecimal(
                              double.parse(provider.indices!
                                  .where((element) =>
                              element.indexCode == provider.selectedIndex,)
                                  .toList()
                                  .first
                                  .currentIndex!))}(${Utils.roundTwoDecimal(
                              (double.parse(provider.indices!
                                  .where((element) =>
                              element.indexCode == provider.selectedIndex,)
                                  .toList()
                                  .first
                                  .netChange!) / provider.indices!
                                  .where((element) =>
                              element.indexCode == provider.selectedIndex,)
                                  .toList()
                                  .first
                    ...
                    Padding(
                      ...
                      child: Row(
                        children: [
                          Text('L: ${Utils.commaSeparated(
                              double.parse(provider.indices!
                                  .where((element) =>
                              element.indexCode == provider.selectedIndex,)
                                  .toList()
                                  .first
                                  .lowIndex!))} -${Utils.roundTwoDecimal(
                              double.parse(provider.indices!
                                  .where((element) =>
                              element.indexCode == provider.selectedIndex,)
                                  .toList()
                                  .first
                                  .lowIndex!) - provider.indices!
                                  .where((element) =>
                              element.indexCode == provider.selectedIndex,)
                                  .toList()
                                  .first
                                  .preClose!)} (${Utils.roundTwoDecimal(
                              ((provider.indices!
                                  .where((element) =>
                              element.indexCode == provider.selectedIndex,)
                                  .toList()
                                  .first
                                  .preClose! - double.parse(provider.indices!
                                  .where((element) =>
                              element.indexCode == provider.selectedIndex,)
                                  .toList()
                                  .first
                                  .lowIndex!)) * 100) / provider.indices!
                                  .where((element) =>
                              element.indexCode == provider.selectedIndex,)
                                  .toList()
                                  .first
                          ...
                          const Spacer(),
                          Text('H: ${Utils.commaSeparated(
                              double.parse(provider.indices!
                                  .where((element) =>
                              element.indexCode == provider.selectedIndex,)
                                  .toList()
                                  .first
                                  .highIndex!))} +${Utils.roundTwoDecimal(
                              double.parse(provider.indices!
                                  .where((element) =>
                              element.indexCode == provider.selectedIndex,)
                                  .toList()
                                  .first
                                  .highIndex!) - provider.indices!
                                  .where((element) =>
                              element.indexCode == provider.selectedIndex,)
                                  .toList()
                                  .first
                    ...
                    Consumer<StockProvider>(
                      builder: (BuildContext context, StockProvider value,
                          Widget? child) {
                        List<StockData> volumnLeaders = List.from(value.stockData)
                          ..sort((a, b) => b.v!.compareTo(a.v!),);
                        List<StockData> gainers = List.from(value.stockData)
                          ..sort((a, b) => b.ch!.compareTo(a.ch!),);
                        List<StockData> losers = List.from(value.stockData)
                          ..sort((a, b) => a.ch!.compareTo(b.ch!),);
                        return Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            ...
                            ListView.builder(
                                shrinkWrap: true,
                                physics: const NeverScrollableScrollPhysics(),
                                itemCount: volumnLeaders.isEmpty
                                    ? 0
                                    : volumnLeaders
                                    .sublist(0, 10)
                                    .length,
                            ...
                            ListView.builder(
                                shrinkWrap: true,
                                physics: const NeverScrollableScrollPhysics(),
                                itemCount: gainers.isEmpty ? 0 : gainers
                                    .sublist(0, 10)
                                    .length,
                                itemBuilder: (context, index) =>
                                    DashboardStockCard(
                                      stockData: gainers[index],)),
                            const SizedBox(height: 20.0,),
                            const Padding(
                              padding: EdgeInsets.only(left: 7.0),
                              child: Text('Losers',
                            ...
                            ListView.builder(
                                shrinkWrap: true,
                                physics: const NeverScrollableScrollPhysics(),
                                itemCount: losers.isEmpty ? 0 : losers
                                    .sublist(0, 10)
                                    .length,
                                itemBuilder: (context, index) =>
                                    DashboardStockCard(stockData: losers[index],))
                          ],
                        );
                      },
