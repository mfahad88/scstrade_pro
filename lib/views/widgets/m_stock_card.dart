...
import 'package:scstrade_pro/views/screens/snapshot/company_snapshot_screen.dart';
...
class mStockCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      onTap: () => Navigator.push(context, MaterialPageRoute(builder: (context) => CompanySnapshotScreen(
